...
export function Footer() {
  return (
    <footer className="mt-10 w-full border-t border-[#C4B9A8] bg-[#C4B9A8] py-6 sm:py-8">
      <div className="mx-auto w-full max-w-5xl space-y-2 px-4 text-center sm:px-6 overflow-hidden">
